...
$catalogue = new MessageCatalogue('es-VE', array (
  ...
  array (
    ...
    'The available quantities for the current product and its combinations are based on the stock in your warehouse (using the advanced stock management system). ' => 'Las cantidades disponibles para el producto actual y sus combinaciones están basadas en el inventario actual de su almacén (usando el sistema de administración de inventario avanzado). ',
...
" o deja este campo vacío para ignorarlo.',
  ...
  array (
    ...
    'If your backup file exceeds this limit, contact your hosting provider for assistance. ' => 'Si el tamaño del archivo de tu copia de seguridad excede este límite, ponte en contacto con tu proveedor de alojamiento web para obtener asistencia técnica. ',
